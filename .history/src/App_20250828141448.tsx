...
import cogknitLogo from "./assets/cogknitLogo.jpg"
import kingsCollegeLogo from "./assets/cogknitLogo.jpg"
import sumsLogo from "./assets/cogknitLogo.jpg"
    ...
    <div className="min-h-screen bg-background relative">
      ...
      <section id="home" className="relative overflow-hidden min-h-screen flex items-center pt-16">
        <div className="absolute inset-0">
          <ImageWithFallback
            src={hackathonBackground || "/placeholder.svg"}
            alt="Junction X Kathmandu hackathon venue"
            className="w-full h-full object-cover opacity-60"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-purple-900/60 via-black/70 to-pink-900/50"></div>
        </div>
        ...
        <div className="relative container mx-auto px-6 py-20">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="glass-card rounded-3xl p-8 md:p-12 mb-8 hover:scale-[1.02] transition-all duration-500 max-w-4xl mx-auto">
              <h1 className="text-6xl md:text-8xl lg:text-9xl mb-4 font-bold text-white leading-tight">Junction X</h1>

              <h2 className="text-4xl md:text-6xl lg:text-7xl mb-8 text-white/90 font-light">Kathmandu</h2>
              ...
              <div className="flex flex-wrap justify-center gap-6 mb-8">
                <div className="glass rounded-full px-6 py-3 flex items-center gap-2 hover:scale-105 transition-all duration-300">
                  ...
                  <span className="text-white/90">March 15-17, 2024</span>
                </div>
                <div className="glass rounded-full px-6 py-3 flex items-center gap-2 hover:scale-105 transition-all duration-300">
                ...
                <div className="glass rounded-full px-6 py-3 flex items-center gap-2 hover:scale-105 transition-all duration-300">
                  ...
                  <span className="text-white/90">200+ Participants</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white text-lg px-8 py-6 rounded-2xl border-0 hover:scale-105 transition-all duration-300"
                >
                  Register for Free
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-white/30 text-white hover:bg-white/10 text-lg px-8 py-6 rounded-2xl hover:scale-105 transition-all duration-300 bg-transparent"
                >
                  Learn More
                </Button>
              </div>

              <div className="glass-subtle rounded-2xl p-4 max-w-md mx-auto">
                <div className="text-sm text-white/80 mb-2">Early Bird Registration Open</div>
                ...
                <div className="text-sm text-white/70">150 of 200 spots filled</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 lg:gap-12 items-center justify-center max-w-4xl mx-auto">
                <div className="group cursor-pointer text-center">
                  <div className="glass-card rounded-3xl p-6 md:p-8 hover:scale-105 transition-all duration-500">
                    <div className="bg-white rounded-2xl p-6 mb-4 shadow-lg">
                      <img
                        src={cogknitLogo || "/placeholder.svg"}
                        alt="Cogknit Logo"
                ...
                <div className="group cursor-pointer text-center">
                  <div className="glass-card rounded-3xl p-6 md:p-8 hover:scale-105 transition-all duration-500">
                    <div className="bg-white rounded-2xl p-4 mb-4 shadow-lg">
                      <img
                        src={kingsCollegeLogo || "/placeholder.svg"}
          ...
          <div className="glass-card rounded-3xl p-8">
            <div className="text-center">
              <div className="flex items-center justify-center gap-3 mb-6">
                ...
                <span className="text-xl text-white">JUNCTION X KATHMANDU 2025</span>
              </div>
              <p className="text-white/70 mb-6 leading-relaxed">
                Brought to you by SUMS Nepal & King's College Nepal | Powered by Cogknit Oy
              </p>
              <div className="flex justify-center gap-6">
                <Button
                  variant="link"
