    ...
    <div className="min-h-screen bg-black relative">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-white/40 text-white hover:bg-white/10 text-lg px-10 py-4 rounded-xl hover:scale-105 transition-all duration-300 bg-transparent font-semibold"
              >
                Learn More
              </Button>
            </div>
      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl mb-8 text-white font-bold">What is Junction X?</h2>
            <p className="text-lg text-white/80 leading-relaxed mb-16 max-w-3xl mx-auto">
              Junction X is the world's leading hackathon series, bringing together the brightest minds to create
              innovative solutions that shape the future. Now coming to Kathmandu for the first time.
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="glass-card rounded-2xl p-6 text-center hover:scale-105 transition-all duration-300">
                ...
                <h3 className="text-xl mb-3 text-white font-semibold">48 Hours of Coding</h3>
              ...
              <div className="glass-card rounded-2xl p-6 text-center hover:scale-105 transition-all duration-300">
                ...
                <h3 className="text-xl mb-3 text-white font-semibold">Innovation Focus</h3>
                <p className="text-white/70 text-sm leading-relaxed">
              ...
              <div className="glass-card rounded-2xl p-6 text-center hover:scale-105 transition-all duration-300">
                ...
                <h3 className="text-xl mb-3 text-white font-semibold">$10,000 in Prizes</h3>
                <p className="text-white/70 text-sm leading-relaxed">
              ...
              <div className="glass-card rounded-2xl p-6 text-center hover:scale-105 transition-all duration-300">
                ...
                <h3 className="text-xl mb-3 text-white font-semibold">Mentorship</h3>
                <p className="text-white/70 text-sm leading-relaxed">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="glass-card rounded-2xl p-8 text-center">
                  ...
                  <div className="text-white/70">Participants Expected</div>
                </div>
              </div>
            </div>
          </div>
