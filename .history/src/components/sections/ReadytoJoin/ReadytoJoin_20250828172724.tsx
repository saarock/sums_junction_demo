        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-4xl mx-auto">
            <div className="glass-card rounded-3xl p-12 text-center relative overflow-hidden">
              <div className="glass-card absolute inset-0 bg-gradient-to-r from--600/20 via-blue-600/20 to-cyan-600/20"></div>
              <div className="relative z-10">
                ...
                <div className="flex justify-center items-center gap-2 m-6">
                  <Input type="email" placeholder="email..." className="w-80 input" />
                </div>
                <Button
                  size="lg"
