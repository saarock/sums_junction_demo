...
import kingsCollegeLogo from "../assets/kingsCollegeLogo.jpg"
import sumsLogo from "../assets/sumsLogo.jpg"
      ...
      <section id="home" className="relative overflow-hidden min-h-screen flex items-center pt-16">
        ...
        <div className="relative container mx-auto px-6 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              <h1 className="text-7xl md:text-8xl lg:text-9xl mb-6 font-bold text-white leading-none tracking-tight">
                Junction X
              </h1>
              <h2 className="text-4xl md:text-5xl lg:text-6xl mb-8 text-white/90 font-light">Kathmandu</h2>
